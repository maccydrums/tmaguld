  ...
  render() {
    return (
      ...
      <Route>
        ...
        <NavDropdown.Item eventKey="4.1"><NavLink to = '/products' activeClassName="my-class" style={{marginLeft: '0px'}}>Förlovnings- och vigselringar</NavLink></NavDropdown.Item>
        ...
        <NavLink to = '/about' activeClassName="my-class" style={{marginRight: '20px'}}>Om oss</NavLink>
